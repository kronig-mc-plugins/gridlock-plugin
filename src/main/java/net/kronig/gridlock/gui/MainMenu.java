    ...
    protected void render() {
        ...
        ItemBuilder info = ItemBuilder.of(Material.NETHER_STAR).glow(true)
                ...
                .lore("<gray>Level-Modus: <white>" + plugin.levels().mode().displayName()
                        + (plugin.levels().mode() == PaymentMode.POOL ? " <dark_gray>(" + data.poolLevels + " Level)" : ""));
        ...
        set(53, ItemBuilder.of(Material.KNOWLEDGE_BOOK)
                ...
                .lore("<gray>/gl pool einzahlen [n] <dark_gray>– Level in Pool")
                .lore("<gray>/timer pause|resume|reset")
                .lore("<gray>/gl start | reset | reload")
                .build());
